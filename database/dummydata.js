...
const addRestaurants = () => {
  return db.Restaurant.findOrCreate({where: {name: 'Tempest', phone: '(123) 456-7890', image: '../images/tempestbar.jpg', status: 'Open', 'average_wait': 10, 'total_wait': 10, rating: 4, address: '123 Tempest St. San Francisco, CA 94102', yelpID: 'Tempest', latitude: 37.767413217936834, longitude: -122.42820739746094, review_count: 1111}})
    ...
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Tsunami Panhandle', phone: '(415) 567-7664', image: '../images/tsunamipanhandle.jpg', status: 'Open', 'average_wait': 5, 'total_wait': 5, rating: 4, address: '123 Tsunami St. San Francisco, CA 94102', yelpID: 'Tsunami Panhandle', latitude: 37.767413217936605, longitude: -122.42820739746123, review_count: 3333}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Kitchen Story', phone: '(415) 525-4905', image: '../images/kitchenstory.jpg', status: 'Open', 'average_wait': 15, 'total_wait': 15, rating: 3, address: '123 Kitchen St. San Francisco, CA 94102', yelpID: 'Kitchen Story', latitude: 37.767413217936987, longitude: -122.42820739746505, review_count: 4444}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Burma Superstar', phone: '(415) 387-2147', image: '../images/burmasuperstar.jpg', status: 'Open', 'average_wait': 10, 'total_wait': 10, rating: 4, address: '123 Burma St. San Francisco, CA 94102', yelpID: 'Burma Superstar', latitude: 37.767413217936444, longitude: -122.42820739746222, review_count: 5555}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'State Bird Provisions', phone: '(415) 795-1272', image: '../images/statebirdprovisions.jpg', status: 'Closed', 'average_wait': 8, 'total_wait': 8, rating: 5, address: '123 Bird St. San Francisco, CA 94102', yelpID: 'Bird State', latitude: 37.767413217936800, longitude: -122.42820739746001, review_count: 6666}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Limon Rotisserie', phone: '(415) 821-2134', image: '../images/limonrotisserie.jpg', status: 'Closed', 'average_wait': 12, 'total_wait': 12, rating: 4, address: '123 Limon St. San Francisco, CA 94102', yelpID: 'Limon', latitude: 37.767413217936345, longitude: -122.42820739746543, review_count: 7777}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Nopa', phone: '(415) 864-8643', image: '../images/nopa.jpg', status: 'Open', 'average_wait': 20, 'total_wait': 20, rating: 3, address: '123 Nopa St. San Francisco, CA 94102', yelpID: 'Nopa', latitude: 37.767413217936777, longitude: -122.42820739746777, review_count: 8888}}))
    .then(() => db.Restaurant.findOrCreate({where: {name: 'Farmhouse Kitchen', phone: '(415) 814-2920', image: '../images/farmhousekitchen.jpg', status: 'Open', 'average_wait': 15, 'total_wait': 15, rating: 5, address: '123 Farmhouse St. San Francisco, CA 94102', yelpID: 'Farmhouse', latitude: 37.767413217936510, longitude: -122.42820739746490, review_count: 9999}}))
    .catch(err => {
